...
void SetSound(uint8 sound_level)
{
    BEGIN_CMD();
    TX_8(0x93);
    TX_8(sound_level);
...
*/
void ShowKeyboard(uint8 show,uint16 x1,uint16 y1,uint8 type1,uint8 option1,uint8 max_len1)
{
    BEGIN_CMD();
    TX_8(0x86);
    TX_8(show);
...
void ScrollText(uint16 screen_id,uint16 control_id,uint16 speed)
{
   BEGIN_CMD();
   TX_8(0xB1);
	 TX_8(0x16);
